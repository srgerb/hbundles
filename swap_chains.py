...
parser.add_argument('s', type=str, nargs=1, help="Takes in 2 PDB files. The first will provide the outer segments of the output file (residues 1-w and x-end) and the second will provide the center segment of the output (residues x-z)")
parser.add_argument('-o', type=str, nargs=1, default=["chimera.pdb"], help="Name of output file")
